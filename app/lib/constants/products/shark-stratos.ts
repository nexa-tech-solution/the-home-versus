...
export const SHARK_STRATOS_PRODUCT: SingleProductData = {
  ...
  price: "$399.99",
  amazonUrl: "https://www.amazon.com/Shark-IZ862H-Stratos-Cordless-Stick/dp/B0B5P7Y8R6",
  rating: 4.6,
  reviewCount: 2100,
  ...
  intro: "The Shark Stratos is Shark's most advanced cordless vacuum to date, featuring Clean Sense IQ to detect dirt and Odor Neutralizer technology to keep your home smelling fresh.",
  pros: [
  ...
  sections: [
    {
      ...
      content: "The Stratos uses an infrared sensor to detect dirt you can't see and automatically increases power. This is great for high-traffic areas and helps maximize battery life by only using full power when necessary."
    },
    {
      title: "The Ultimate Tool for Pet Parents",
      content: "The DuoClean PowerFins HairPro brushroll is a game changer for long hair. It literally digs into carpets and pulls up hair that other vacuums leave behind, and it rarely gets tangled."
    }
  ],
  relatedProducts: [
    {
