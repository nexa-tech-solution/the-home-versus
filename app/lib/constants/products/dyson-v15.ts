...
export const DYSON_V15_PRODUCT: SingleProductData = {
  ...
  intro: "The Dyson V15 Detect isn't just a vacuum; it's a scientific tool for your home. With its laser dust detection and piezo sensor, it brings a level of cleanliness you can actually see and measure.",
  pros: [
  ...
  sections: [
    {
      ...
      content: "The standout feature is the precisely-angled laser which makes invisible dust visible on hard floors – so you don’t miss anything. It's oddly satisfying to see a green light reveal pet hair and dust you didn't even know was there."
    },
    {
      title: "Scientific Proof of a Deep Clean",
      content: "The piezo sensor continuously sizes and counts dust particles – automatically increasing suction power when needed. The LCD screen shows you exactly what’s been sucked up, giving you real-time scientific proof of a deep clean."
    }
  ],
  relatedProducts: [
    {
