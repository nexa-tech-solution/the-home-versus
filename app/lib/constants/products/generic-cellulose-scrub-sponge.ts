...
export const GENERIC_SPONGE: SingleProductData = {
  ...
  media: [
    {
      type: "image",
      url: "https://m.media-amazon.com/images/I/619wP5245EL._AC_SY450_.jpg",
      caption:
        "The classic yellow and green cellulose scrub sponge—the unofficial mascot of household chores.",
    },
    {
      type: "image",
      url: "https://m.media-amazon.com/images/I/61D6Ridc5IL._AC_SY450_.jpg",
      caption:
        "Standard dual-sided design: Absorbent cellulose on one side, abrasive scouring pad on the other.",
    },
    {
      type: "image",
      url: "https://m.media-amazon.com/images/I/61u9S1I3JCL._AC_SY450_.jpg",
      caption:
        "High absorbency makes these ideal for soaking up spills or wiping down countertops.",
    },
    {
      type: "image",
      url: "https://m.media-amazon.com/images/I/61xfdzSUkpL._AC_SY450_.jpg",
      caption:
        "Biodegradable fibers allow the yellow portion to be composted after the scouring pad is removed.",
    },
  ],
  pros: [
  ...
  relatedProducts: [
    {
      slug: "scrub-daddy-dye-free-scratch-free-scrubber",
      name: "Scrub Daddy Dye-Free Scrubber",
      image: "https://m.media-amazon.com/images/I/71LeSqpg9mL._AC_SX679_.jpg",
      price: "$3.99",
    },
  ],
};
