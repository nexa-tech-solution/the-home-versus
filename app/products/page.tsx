...
export default function ProductsPage() {
  const products = Object.values(PRODUCT_DATA);
        ...
        <section className="container py-12 md:py-20">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              ...
              <p className="text-muted-foreground flex items-center gap-2 uppercase tracking-widest text-xs font-bold">
                ...
                Reviewing {products.length} battle-tested products
              </p>
            </div>
          ...
          {products.length === 0 && (
            <div className="py-24 text-center">
              ...
              <p className="text-xl text-muted-foreground">We're currently testing more products. Stay tuned!</p>
            </div>
          )}
